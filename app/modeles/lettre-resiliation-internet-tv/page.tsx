...
export const metadata: Metadata = {
  title: "Lettre résiliation Internet TV Suisse – modèle conforme & envoi recommandé",
  description: "Générez et envoyez votre lettre de résiliation d'abonnement Internet TV en Suisse. Modèle conforme, envoi recommandé avec preuve.",
  alternates: {
    canonical: "/modeles/lettre-resiliation-internet-tv",
  },
}

const faqData = [
  {
    question: "Quand puis-je résilier mon abonnement Internet TV en Suisse ?",
    answer: "Les conditions de résiliation varient selon votre contrat. Certains abonnements peuvent être résiliés à tout moment avec un préavis, d'autres peuvent avoir des durées minimales. Vérifiez les conditions spécifiques de votre contrat d'abonnement Internet TV.",
  },
  {
    question: "Dois-je envoyer ma résiliation d'abonnement Internet TV par courrier recommandé ?",
  ...
  {
    question: "Que doit contenir une lettre de résiliation d'abonnement Internet TV ?",
    answer: "Une lettre de résiliation d'abonnement Internet TV doit contenir vos coordonnées, votre numéro de contrat, le nom de l'opérateur, la date de résiliation souhaitée. Le modèle NextLetter inclut tous ces éléments essentiels.",
  },
  {
    question: "Puis-je résilier mon abonnement Internet TV à tout moment ?",
    answer: "Les conditions de résiliation varient selon votre contrat. Certains abonnements peuvent être résiliés à tout moment avec un préavis, d'autres peuvent avoir des durées minimales ou des frais de résiliation anticipée. Consultez votre contrat ou contactez votre opérateur.",
  },
  {
    question: "NextLetter fournit-il des conseils juridiques ?",
    answer: "Non, NextLetter est un service numérique d'assistance à la rédaction et à l'envoi de courriers. Nous ne fournissons aucun conseil juridique. Pour des questions spécifiques, consultez un professionnel du droit ou votre opérateur.",
  },
]

export default function LettreResiliationInternetTVPage() {
  return (
    <>
      <FaqJsonLd id="schema-faq-lettre-resiliation-internet-tv" data={faqData} />
      <div className="min-h-screen bg-background">
        ...
        <main className="relative z-10">
          <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-16">
              ...
              <h1 className="text-3xl sm:text-4xl font-semibold mb-4">
                ...
                <span className="relative inline-block">
                  <span className="relative z-10 bg-gradient-to-r from-blue-600 via-blue-500 to-cyan-500 bg-clip-text text-transparent animate-gradient-x">
                    d'abonnement Internet TV en Suisse
                  </span>
                  {/* Glow effect */}
            ...
            <ModelInlineGeo
              canonicalPath="/modeles/lettre-resiliation-internet-tv"
              h1Title="Résiliation"
              h1Gradient="d'abonnement Internet TV en Suisse"
              introLine="Résiliez votre abonnement Internet TV en Suisse en quelques minutes. Votre lettre est générée, personnalisée et envoyée par courrier recommandé avec preuve d'envoi."
            />

            {/* Introduction */}
            <div className="prose prose-lg max-w-none mb-12">
              <p className="text-lg text-muted-foreground leading-relaxed mb-3">
                Résiliez votre abonnement Internet TV en Suisse en quelques minutes. Votre lettre est générée, personnalisée et envoyée par courrier recommandé avec preuve d'envoi.
              </p>
            ...
            <section className="mb-12 bg-card border border-border rounded-2xl p-6 sm:p-8">
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                <p>
                  En Suisse, la résiliation d'abonnement Internet TV doit être effectuée <strong>par écrit</strong>. Les conditions de résiliation varient selon votre contrat : certains peuvent être résiliés à tout moment avec un préavis, d'autres peuvent avoir des durées minimales.
                </p>
                <p>
                ...
                <p>
                  Vérifiez toujours les conditions spécifiques de votre contrat d'abonnement Internet TV avant d'envoyer votre résiliation.
                </p>
                <p className="text-sm italic pt-4 border-t border-border">
                  ⚠️ NextLetter est un service numérique d'assistance à la rédaction et à l'envoi de courriers. Nous ne fournissons aucun conseil juridique. Pour des questions spécifiques, consultez un professionnel du droit ou votre opérateur.
                </p>
              </div>
            </section>
            ...
            <section className="mb-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="bg-card border border-border rounded-xl p-6">
                  ...
                  <p className="text-muted-foreground text-sm">Sélectionnez le modèle de résiliation d'abonnement Internet TV adapté à votre situation.</p>
                </div>
                <div className="bg-card border border-border rounded-xl p-6">
                  <div className="w-12 h-12 bg-brand/10 rounded-lg flex items-center justify-center mb-4">
                  ...
                  <p className="text-muted-foreground text-sm">Remplissez vos coordonnées, votre numéro de contrat et les dates.</p>
                </div>
                <div className="bg-card border border-border rounded-xl p-6">
                  <div className="w-12 h-12 bg-brand/10 rounded-lg flex items-center justify-center mb-4">
              ...
              <div className="relative z-10">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-brand mt-0.5 flex-shrink-0" />
                    <div>
                      <p className="font-medium text-foreground text-sm">Numéro de contrat</p>
                  ...
                  <div className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-brand mt-0.5 flex-shrink-0" />
                    <div>
                      <p className="font-medium text-foreground text-sm">Coordonnées de l'opérateur</p>
                      <p className="text-xs text-muted-foreground">Nom et adresse de votre opérateur</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-brand mt-0.5 flex-shrink-0" />
            ...
            <section className="mb-12">
              ...
              <div className="bg-card border border-border rounded-xl overflow-hidden">
                <table className="w-full">
                  ...
                  <tbody className="divide-y divide-border">
                    <tr>
                      <td className="px-4 py-3 text-sm text-muted-foreground">Abonnement Internet TV</td>
              ...
              <p className="text-sm text-muted-foreground mt-4 italic">
                ⚠️ Les délais peuvent varier selon votre contrat. Vérifiez toujours les conditions spécifiques de votre abonnement Internet TV.
              </p>
            </section>
            ...
            <section className="mb-12 text-center bg-gradient-to-br from-brand/5 to-cyan-500/5 border border-brand/20 rounded-2xl p-8 sm:p-12 relative overflow-hidden group">
              ...
              <div className="relative z-10">
                <h2 className="text-2xl sm:text-3xl font-bold text-foreground mb-4">
                  Prêt à résilier votre abonnement Internet TV ?
                </h2>
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-3">
                  <a
                    href={addUtmParams(appUrls.base, 'landing', 'cta', 'resiliation-internet-tv')}
                    target="_blank"
