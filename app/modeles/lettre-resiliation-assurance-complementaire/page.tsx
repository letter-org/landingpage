...
export const metadata: Metadata = {
  title: "Lettre résiliation assurance complémentaire Suisse – modèle conforme & envoi recommandé",
  description: "Générez et envoyez votre lettre de résiliation d'assurance complémentaire en Suisse. Modèle conforme, envoi recommandé avec preuve.",
  alternates: {
    canonical: "/modeles/lettre-resiliation-assurance-complementaire",
  },
}

const faqData = [
  {
    question: "Quand puis-je résilier mon assurance complémentaire en Suisse ?",
    answer: "L'assurance complémentaire peut généralement être résiliée une fois par an, avec un délai de préavis qui varie selon le contrat (souvent 3 mois). Vérifiez les conditions spécifiques de votre contrat d'assurance complémentaire.",
  },
  {
    question: "Dois-je envoyer ma résiliation d'assurance complémentaire par courrier recommandé ?",
  ...
  {
    question: "Que doit contenir une lettre de résiliation d'assurance complémentaire ?",
    answer: "Une lettre de résiliation d'assurance complémentaire doit contenir vos coordonnées, votre numéro de contrat, le nom de l'assureur, la date de résiliation souhaitée, et éventuellement le motif si requis. Le modèle NextLetter inclut tous ces éléments essentiels.",
  },
  {
    question: "Puis-je résilier mon assurance complémentaire à tout moment ?",
    answer: "Les conditions de résiliation varient selon votre contrat. Certaines assurances complémentaires peuvent être résiliées une fois par an, d'autres peuvent avoir des conditions spécifiques. Consultez votre contrat ou contactez votre assureur.",
  },
  {
...
export default function LettreResiliationAssuranceComplementairePage() {
  return (
    <>
      <FaqJsonLd id="schema-faq-lettre-resiliation-assurance-complementaire" data={faqData} />
      <div className="min-h-screen bg-background">
        ...
        <main className="relative z-10">
          <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-16">
              ...
              <h1 className="text-3xl sm:text-4xl font-semibold mb-4">
                ...
                <span className="relative inline-block">
                  <span className="relative z-10 bg-gradient-to-r from-blue-600 via-blue-500 to-cyan-500 bg-clip-text text-transparent animate-gradient-x">
                    d'assurance complémentaire en Suisse
                  </span>
                  {/* Glow effect */}
            ...
            <ModelInlineGeo
              canonicalPath="/modeles/lettre-resiliation-assurance-complementaire"
              h1Title="Résiliation"
              h1Gradient="d'assurance complémentaire en Suisse"
              introLine="Résiliez votre assurance complémentaire en Suisse en quelques minutes. Votre lettre est générée, personnalisée et envoyée par courrier recommandé avec preuve d'envoi."
            />

            {/* Introduction */}
            <div className="prose prose-lg max-w-none mb-12">
              <p className="text-lg text-muted-foreground leading-relaxed mb-3">
                Résiliez votre assurance complémentaire en Suisse en quelques minutes. Votre lettre est générée, personnalisée et envoyée par courrier recommandé avec preuve d'envoi.
              </p>
            ...
            <section className="mb-12 bg-card border border-border rounded-2xl p-6 sm:p-8">
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                <p>
                  En Suisse, la résiliation d'assurance complémentaire doit être effectuée <strong>par écrit</strong>. Les conditions de résiliation varient selon votre contrat : certaines peuvent être résiliées une fois par an, d'autres ont des conditions spécifiques.
                </p>
                <p>
                  Le délai de préavis est souvent de <strong>3 mois</strong>, mais peut varier selon votre contrat. L'envoi par <strong>courrier recommandé est fortement recommandé</strong> afin de disposer d'une preuve d'envoi et de réception.
                </p>
                <p>
                  Vérifiez toujours les conditions spécifiques de votre contrat d'assurance complémentaire avant d'envoyer votre résiliation.
                </p>
            ...
            <section className="mb-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="bg-card border border-border rounded-xl p-6">
                  ...
                  <p className="text-muted-foreground text-sm">Sélectionnez le modèle de résiliation d'assurance complémentaire adapté à votre situation.</p>
                </div>
                <div className="bg-card border border-border rounded-xl p-6">
                  <div className="w-12 h-12 bg-brand/10 rounded-lg flex items-center justify-center mb-4">
                  ...
                  <p className="text-muted-foreground text-sm">Remplissez vos coordonnées, votre numéro de contrat et les dates de résiliation.</p>
                </div>
                <div className="bg-card border border-border rounded-xl p-6">
                  <div className="w-12 h-12 bg-brand/10 rounded-lg flex items-center justify-center mb-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground">Référence de votre assurance complémentaire</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-brand mt-0.5 flex-shrink-0" />
            ...
            <section className="mb-12">
                ...
                <table className="w-full">
                  <thead className="bg-secondary">
                    <tr>
                      ...
                      <th className="px-4 py-3 text-left text-sm font-semibold text-foreground">Fréquence de résiliation</th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-border">
                    <tr>
                      <td className="px-4 py-3 text-sm text-muted-foreground">Assurance complémentaire</td>
                      <td className="px-4 py-3 text-sm text-muted-foreground">Souvent 3 mois (selon contrat)</td>
              ...
              <p className="text-sm text-muted-foreground mt-4 italic">
                ⚠️ Les délais peuvent varier selon votre contrat. Vérifiez toujours les conditions spécifiques de votre assurance complémentaire.
              </p>
            </section>
            ...
            <section className="mb-12 text-center bg-gradient-to-br from-brand/5 to-cyan-500/5 border border-brand/20 rounded-2xl p-8 sm:p-12 relative overflow-hidden group">
              ...
              <div className="relative z-10">
                <h2 className="text-2xl sm:text-3xl font-bold text-foreground mb-4">
                  Prêt à résilier votre assurance complémentaire ?
                </h2>
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-3">
                  <a
                    href={addUtmParams(appUrls.base, 'landing', 'cta', 'resiliation-assurance-complementaire')}
                    target="_blank"
                  ...
                  <Link
                    href="/modeles/lettre-resiliation-assurance-maladie-suisse"
