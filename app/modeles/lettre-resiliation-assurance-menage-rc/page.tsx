...
export const metadata: Metadata = {
  title: "Lettre résiliation assurance ménage RC Suisse – modèle conforme & envoi recommandé",
  description: "Générez et envoyez votre lettre de résiliation d'assurance ménage RC en Suisse. Modèle conforme, envoi recommandé avec preuve.",
  alternates: {
    canonical: "/modeles/lettre-resiliation-assurance-menage-rc",
  },
}

const faqData = [
  {
    question: "Quand puis-je résilier mon assurance ménage RC en Suisse ?",
    answer: "L'assurance ménage RC peut généralement être résiliée une fois par an, avec un délai de préavis qui varie selon le contrat (souvent 3 mois). Vérifiez les conditions spécifiques de votre contrat d'assurance ménage RC.",
  },
  {
    question: "Dois-je envoyer ma résiliation d'assurance ménage RC par courrier recommandé ?",
  ...
  {
    question: "Que doit contenir une lettre de résiliation d'assurance ménage RC ?",
    answer: "Une lettre de résiliation d'assurance ménage RC doit contenir vos coordonnées, votre numéro de contrat, le nom de l'assureur, la date de résiliation souhaitée, et éventuellement le motif si requis. Le modèle NextLetter inclut tous ces éléments essentiels.",
  },
  {
    question: "Puis-je résilier mon assurance ménage RC à tout moment ?",
    answer: "Les conditions de résiliation varient selon votre contrat. Certaines assurances ménage RC peuvent être résiliées une fois par an, d'autres peuvent avoir des conditions spécifiques. Consultez votre contrat ou contactez votre assureur.",
  },
  {
...
export default function LettreResiliationAssuranceMenageRCPage() {
  return (
    <>
      <FaqJsonLd id="schema-faq-lettre-resiliation-assurance-menage-rc" data={faqData} />
      <div className="min-h-screen bg-background">
        ...
        <main className="relative z-10">
          <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-16">
              ...
              <h1 className="text-3xl sm:text-4xl font-semibold mb-4">
                ...
                <span className="relative inline-block">
                  <span className="relative z-10 bg-gradient-to-r from-blue-600 via-blue-500 to-cyan-500 bg-clip-text text-transparent animate-gradient-x">
                    d'assurance ménage RC en Suisse
                  </span>
                  {/* Glow effect */}
            ...
            <ModelInlineGeo
              canonicalPath="/modeles/lettre-resiliation-assurance-menage-rc"
              h1Title="Résiliation"
              h1Gradient="d'assurance ménage RC en Suisse"
              introLine="Résiliez votre assurance ménage RC en Suisse en quelques minutes. Votre lettre est générée, personnalisée et envoyée par courrier recommandé avec preuve d'envoi."
            />

            {/* Introduction */}
            <div className="prose prose-lg max-w-none mb-12">
              <p className="text-lg text-muted-foreground leading-relaxed mb-3">
                Résiliez votre assurance ménage RC en Suisse en quelques minutes. Votre lettre est générée, personnalisée et envoyée par courrier recommandé avec preuve d'envoi.
              </p>
            ...
            <section className="mb-12 bg-card border border-border rounded-2xl p-6 sm:p-8">
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                <p>
                  En Suisse, la résiliation d'assurance ménage RC doit être effectuée <strong>par écrit</strong>. Les conditions de résiliation varient selon votre contrat : certaines peuvent être résiliées une fois par an, d'autres ont des conditions spécifiques.
                </p>
                <p>
                ...
                <p>
                  Vérifiez toujours les conditions spécifiques de votre contrat d'assurance ménage RC avant d'envoyer votre résiliation.
                </p>
            ...
            <section className="mb-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="bg-card border border-border rounded-xl p-6">
                  ...
                  <p className="text-muted-foreground text-sm">Sélectionnez le modèle de résiliation d'assurance ménage RC adapté à votre situation.</p>
                </div>
                <div className="bg-card border border-border rounded-xl p-6">
                  <div className="w-12 h-12 bg-brand/10 rounded-lg flex items-center justify-center mb-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground">Référence de votre assurance ménage RC</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-brand mt-0.5 flex-shrink-0" />
            ...
            <section className="mb-12">
              ...
              <p className="text-sm text-muted-foreground mt-4 italic">
                ⚠️ Les délais peuvent varier selon votre contrat. Vérifiez toujours les conditions spécifiques de votre assurance ménage RC.
              </p>
            </section>
            ...
            <section className="mb-12 text-center bg-gradient-to-br from-brand/5 to-cyan-500/5 border border-brand/20 rounded-2xl p-8 sm:p-12 relative overflow-hidden group">
              ...
              <div className="relative z-10">
                <h2 className="text-2xl sm:text-3xl font-bold text-foreground mb-4">
                  Prêt à résilier votre assurance ménage RC ?
                </h2>
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-3">
                  <a
                    href={addUtmParams(appUrls.base, 'landing', 'cta', 'resiliation-assurance-menage-rc')}
                    target="_blank"
