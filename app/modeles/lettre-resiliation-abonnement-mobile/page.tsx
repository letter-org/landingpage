...
export const metadata: Metadata = {
  ...
  description: "Générez et envoyez votre lettre de résiliation d'abonnement mobile en Suisse. Modèle conforme, envoi recommandé avec preuve.",
  alternates: {
    canonical: "/modeles/lettre-resiliation-abonnement-mobile",
  },
}

const faqData = [
  {
    question: "Quand puis-je résilier mon abonnement mobile en Suisse ?",
    answer: "Les conditions de résiliation varient selon votre contrat. Certains abonnements peuvent être résiliés à tout moment avec un préavis, d'autres peuvent avoir des durées minimales. Vérifiez les conditions spécifiques de votre contrat d'abonnement mobile.",
  },
  {
    question: "Dois-je envoyer ma résiliation d'abonnement mobile par courrier recommandé ?",
  ...
  {
    question: "Que doit contenir une lettre de résiliation d'abonnement mobile ?",
    answer: "Une lettre de résiliation d'abonnement mobile doit contenir vos coordonnées, votre numéro de contrat ou de ligne, le nom de l'opérateur, la date de résiliation souhaitée. Le modèle NextLetter inclut tous ces éléments essentiels.",
  },
  {
    question: "Puis-je résilier mon abonnement mobile à tout moment ?",
...
export default function LettreResiliationAbonnementMobilePage() {
  return (
    <>
      <FaqJsonLd id="schema-faq-lettre-resiliation-abonnement-mobile" data={faqData} />
          ...
          <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-16">
            ...
            <div className="prose prose-lg max-w-none mb-12">
              <p className="text-lg text-muted-foreground leading-relaxed mb-3">
                Résiliez votre abonnement mobile en Suisse en quelques minutes. Votre lettre est générée, personnalisée et envoyée par courrier recommandé avec preuve d'envoi.
              </p>
            ...
            <section className="mb-12 bg-card border border-border rounded-2xl p-6 sm:p-8">
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                <p>
                  En Suisse, la résiliation d'abonnement mobile doit être effectuée <strong>par écrit</strong>. Les conditions de résiliation varient selon votre contrat : certains peuvent être résiliés à tout moment avec un préavis, d'autres peuvent avoir des durées minimales.
                </p>
                <p>
                ...
                <p>
                  Vérifiez toujours les conditions spécifiques de votre contrat d'abonnement mobile avant d'envoyer votre résiliation.
                </p>
            ...
            <section className="mb-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="bg-card border border-border rounded-xl p-6">
                  ...
                  <p className="text-muted-foreground text-sm">Sélectionnez le modèle de résiliation d'abonnement mobile adapté à votre situation.</p>
                </div>
                <div className="bg-card border border-border rounded-xl p-6">
                  <div className="w-12 h-12 bg-brand/10 rounded-lg flex items-center justify-center mb-4">
                  ...
                  <p className="text-muted-foreground text-sm">Remplissez vos coordonnées, votre numéro de contrat ou de ligne et les dates.</p>
                </div>
                <div className="bg-card border border-border rounded-xl p-6">
                  <div className="w-12 h-12 bg-brand/10 rounded-lg flex items-center justify-center mb-4">
              ...
              <div className="relative z-10">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-brand mt-0.5 flex-shrink-0" />
                    <div>
                      <p className="font-medium text-foreground text-sm">Numéro de contrat ou ligne</p>
            ...
            <section className="mb-12">
              ...
              <p className="text-sm text-muted-foreground mt-4 italic">
                ⚠️ Les délais peuvent varier selon votre contrat. Vérifiez toujours les conditions spécifiques de votre abonnement mobile.
              </p>
            </section>
            ...
            <section className="mb-12 text-center bg-gradient-to-br from-brand/5 to-cyan-500/5 border border-brand/20 rounded-2xl p-8 sm:p-12 relative overflow-hidden group">
              ...
              <div className="relative z-10">
                <h2 className="text-2xl sm:text-3xl font-bold text-foreground mb-4">
                  Prêt à résilier votre abonnement mobile ?
                </h2>
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-3">
                  <a
                    href={addUtmParams(appUrls.base, 'landing', 'cta', 'resiliation-abonnement-mobile')}
                    target="_blank"
                  ...
                  <Link
                    href="/modeles/lettre-resiliation-internet-tv"
