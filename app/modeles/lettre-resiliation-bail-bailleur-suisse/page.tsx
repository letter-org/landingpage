...
export const metadata: Metadata = {
  title: "Lettre résiliation bail bailleur Suisse – modèle conforme & envoi recommandé",
  description: "Générez et envoyez votre lettre de résiliation de bail en tant que propriétaire en Suisse. Modèle conforme, envoi recommandé avec preuve.",
  alternates: {
    canonical: "/modeles/lettre-resiliation-bail-bailleur-suisse",
  },
  openGraph: {
    title: "Lettre résiliation bail bailleur Suisse – modèle conforme & envoi recommandé",
    description: "Générez et envoyez votre lettre de résiliation de bail en tant que propriétaire en Suisse. Modèle conforme, envoi recommandé avec preuve.",
    url: "/modeles/lettre-resiliation-bail-bailleur-suisse",
  },
}

const faqData = [
  {
    question: "Quel est le délai de préavis pour résilier un bail en tant que bailleur ?",
    answer: "Le délai de préavis est généralement de 3 mois pour le bailleur, mais peut varier selon le type de bail et les clauses contractuelles. Vérifiez votre contrat de location pour connaître le délai exact applicable.",
  },
  {
  ...
  {
    question: "Quelles sont les raisons légales pour résilier un bail en tant que bailleur ?",
    answer: "Un bailleur peut résilier un bail pour des raisons légales telles que le besoin personnel, la vente du bien, ou en cas de manquement grave du locataire. Consultez un professionnel du droit pour connaître les conditions exactes applicables à votre situation.",
  },
  {
    question: "Que doit contenir une lettre de résiliation de bail du bailleur ?",
    answer: "Une lettre de résiliation de bail doit contenir vos coordonnées, celles du locataire, la date de résiliation, la date de libération des lieux, l'adresse du logement concerné, et le motif de résiliation si applicable. Le modèle NextLetter inclut tous ces éléments essentiels.",
  },
  {
    question: "Quand dois-je envoyer ma lettre de résiliation ?",
    answer: "Vous devez envoyer votre lettre de résiliation au moins 3 mois avant la date souhaitée de libération des lieux, en respectant les dates d'échéance du bail (généralement fin de trimestre).",
  },
  {
    question: "NextLetter fournit-il des conseils juridiques ?",
    answer: "Non, NextLetter est un service numérique d'assistance à la rédaction et à l'envoi de courriers. Nous ne fournissons aucun conseil juridique. Pour des questions spécifiques, consultez un professionnel du droit.",
  },
]

export default function LettreResiliationBailBailleurPage() {
  return (
    <>
      <FaqJsonLd id="schema-faq-lettre-resiliation-bail-bailleur-suisse" data={faqData} />
      <div className="min-h-screen bg-background">
        ...
        <main className="relative z-10">
          <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-16">
            ...
            <ModelInlineGeo
              canonicalPath="/modeles/lettre-resiliation-bail-bailleur-suisse"
              h1Title="Résiliation"
              h1Gradient="de bail bailleur en Suisse"
              introLine="Résiliez un bail de location en tant que propriétaire en Suisse en quelques minutes. Votre lettre est générée, personnalisée et envoyée par courrier recommandé avec preuve d'envoi."
            />

            {/* Introduction */}
            <div className="prose prose-lg max-w-none mb-12">
              <p className="text-lg text-muted-foreground leading-relaxed mb-3">
                Résiliez un bail de location en tant que propriétaire en Suisse en quelques minutes. Votre lettre est générée, personnalisée et envoyée par courrier recommandé avec preuve d'envoi.
              </p>
            ...
            <section className="mb-12 bg-card border border-border rounded-2xl p-6 sm:p-8">
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                <p>
                  En Suisse, la résiliation de bail par le bailleur doit être effectuée <strong>par écrit</strong>. Le délai de préavis est généralement de <strong>3 mois</strong>, mais peut varier selon votre contrat.
                </p>
                <p>
                  L'envoi par <strong>courrier recommandé est fortement recommandé</strong> afin de disposer d'une preuve d'envoi et de réception. Cela vous protège en cas de litige concernant la date de réception de votre résiliation.
                </p>
                <p>
                  La résiliation doit respecter les dates d'échéance du bail, généralement en fin de trimestre (31 mars, 30 juin, 30 septembre, 31 décembre). Certaines résiliations peuvent nécessiter un motif légal (besoin personnel, vente, etc.).
                </p>
            ...
            <section className="mb-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="bg-card border border-border rounded-xl p-6">
                  ...
                  <p className="text-muted-foreground text-sm">Sélectionnez le modèle de résiliation de bail bailleur adapté à votre situation.</p>
                </div>
                <div className="bg-card border border-border rounded-xl p-6">
                  <div className="w-12 h-12 bg-brand/10 rounded-lg flex items-center justify-center mb-4">
                  ...
                  <p className="text-muted-foreground text-sm">Remplissez vos coordonnées, celles du locataire et les dates de résiliation.</p>
                </div>
                <div className="bg-card border border-border rounded-xl p-6">
                  <div className="w-12 h-12 bg-brand/10 rounded-lg flex items-center justify-center mb-4">
              ...
              <div className="relative z-10">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-brand mt-0.5 flex-shrink-0" />
                    <div>
                      <p className="font-medium text-foreground text-sm">Coordonnées du locataire</p>
                      <p className="text-xs text-muted-foreground">Adresse et références contractuelles</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-brand mt-0.5 flex-shrink-0" />
                    <div>
                      <p className="font-medium text-foreground text-sm">Dates de résiliation</p>
                  ...
                  <div className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-brand mt-0.5 flex-shrink-0" />
                    <div>
                      <p className="font-medium text-foreground text-sm">Références contractuelles</p>
                      <p className="text-xs text-muted-foreground">Adresse du logement, numéro de bail</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-brand mt-0.5 flex-shrink-0" />
                    <div>
                      <p className="font-medium text-foreground text-sm">Motif de résiliation (si applicable)</p>
                      <p className="text-xs text-muted-foreground">Besoin personnel, vente, etc.</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <section className="mb-12">
              ...
              <div className="bg-card border border-border rounded-xl overflow-hidden">
                <table className="w-full">
                  <thead className="bg-secondary">
                    <tr>
                      <th className="px-4 py-3 text-left text-sm font-semibold text-foreground">Type de résiliation</th>
                      <th className="px-4 py-3 text-left text-sm font-semibold text-foreground">Délai de préavis</th>
                      <th className="px-4 py-3 text-left text-sm font-semibold text-foreground">Date d'échéance</th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-border">
                    <tr>
                      <td className="px-4 py-3 text-sm text-muted-foreground">Résiliation ordinaire</td>
                      <td className="px-4 py-3 text-sm text-muted-foreground">3 mois</td>
                      <td className="px-4 py-3 text-sm text-muted-foreground">Fin de trimestre (selon contrat)</td>
                    </tr>
                    <tr>
                      <td className="px-4 py-3 text-sm text-muted-foreground">Résiliation pour besoin personnel</td>
                      <td className="px-4 py-3 text-sm text-muted-foreground">3 mois</td>
                      <td className="px-4 py-3 text-sm text-muted-foreground">Fin de trimestre (selon contrat)</td>
                    </tr>
                    <tr>
                      <td className="px-4 py-3 text-sm text-muted-foreground">Résiliation pour vente</td>
              ...
              <p className="text-sm text-muted-foreground mt-4 italic">
                ⚠️ Les délais peuvent varier selon votre contrat. Vérifiez toujours les clauses spécifiques de votre bail.
              </p>
            </section>
            ...
            <section className="mb-12 text-center bg-gradient-to-br from-brand/5 to-cyan-500/5 border border-brand/20 rounded-2xl p-8 sm:p-12 relative overflow-hidden group">
              ...
              <div className="relative z-10">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-3">
                  <a
                    href={addUtmParams(appUrls.base, 'landing', 'cta', 'resiliation-bail-bailleur')}
                    target="_blank"
            ...
            <section className="mb-12">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                <Link href="/modeles/lettre-resiliation-bail-locataire-suisse" className="bg-card border border-border rounded-lg p-4 hover:border-brand/40 transition-colors">
                  ...
                  <p className="text-sm text-muted-foreground">Modèle pour le locataire</p>
                </Link>
